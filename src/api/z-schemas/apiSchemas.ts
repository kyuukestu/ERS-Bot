...
export const MoveDataSchema = z.object({
	...
	meta: z
		.object({
      ailment: z.object({ name: z.string() }).optional(),
      ailment_chance: z.number().optional(),
			category: z.object({ name: z.string() }).optional(),
			stat_chance: z.number().optional(),
			flinch_chance: z.number().optional(),
			crit_rate: z.number().optional(),
			drain: z.number().optional(),
			healing: z.number().optional(),
			min_hits: z.number().nullable().optional(),
			max_hits: z.number().nullable().optional(),
			min_turns: z.number().nullable().optional(),
